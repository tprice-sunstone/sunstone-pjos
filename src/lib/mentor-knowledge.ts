...
export const PJOS_PLATFORM_GUIDE = {
  ...
  subscriptionAndBilling: {
    ...
    crmAddOn: {
      ...
      includes: ['Your own dedicated business phone number', 'Two-way SMS conversations with clients', 'Messages inbox for all conversations', 'Automated aftercare sequences', 'Follow-up and re-engagement campaigns', 'Broadcast messaging to client segments', 'Birthday and anniversary automations', 'Private party booking with RSVP tracking', 'Client intelligence and spending insights'],
